...
urlpatterns = [
    ...
    # Course
    path('download/course/', views.download_course_template, name='download_course_template'),
    path('upload/course/', views.upload_course_excel, name='upload_course_excel'),
